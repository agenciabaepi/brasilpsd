...
-- ============================================================================
-- 4. ATUALIZAR: Função get_user_download_status para garantir uso de recursos únicos
-- ============================================================================
...
BEGIN
  ...
  -- Contar recursos ÚNICOS baixados hoje (usando a função atualizada)
...
'Retorna status completo de downloads do usuário: contagem atual (recursos únicos), limite, restantes, se permitido e tier. Atualizado para contar apenas recursos únicos.';
