            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { id: 'lite', name: 'Lite', price: createFormData.billingCycle === 'monthly' ? '19,90' : '19,90' },
                    { id: 'pro', name: 'Pro', price: createFormData.billingCycle === 'monthly' ? '29,90' : '29,90' },
                    { id: 'plus', name: 'Plus', price: createFormData.billingCycle === 'monthly' ? '49,90' : '49,90' }
                  ].map((tier) => (
                    <button
                      key={tier.id}
