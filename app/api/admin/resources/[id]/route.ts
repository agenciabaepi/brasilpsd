...
import { deleteFileFromS3, getS3Url } from '@/lib/aws/s3'
...
export async function DELETE(
  ...
  try {
    ...
    if (!profile?.is_admin) {
      return NextResponse.json({ error: 'Acesso negado. Apenas administradores podem deletar recursos.' }, { status: 403 })
    }
    ...
    console.log('Resource deleted from database:', resourceId, deleteData)
