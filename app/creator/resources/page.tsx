...
export default function CreatorResourcesPage() {
  ...
  const loadResources = useCallback(async () => {
    // Não carregar se ainda não temos categorias e precisamos delas
    if (categoryFilter !== 'all' && categoryFilter !== 'uncategorized' && categories.length === 0) {
      return
    }
  ...
  }, [supabase, router, categoryFilter, categories, searchQuery, isLoadingResources])
        ...
        <div className="p-6 border-b border-gray-50 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="h-12 px-4 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/10 transition-all bg-white"
            >
